...
describe('WebhooksPage', () => {
  ...
  it('renders shared-console metrics and delivery operations for admin role', async () => {
    ...
    const deliveryMetrics = screen.getByText('最近回调').closest('.semi-space')
    expect(deliveryMetrics).not.toBeNull()
    expect(within(deliveryMetrics as HTMLElement).getByText('2026-04-29T00:03:00Z')).toBeInTheDocument()
