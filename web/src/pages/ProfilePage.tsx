    ...
    switch (user?.role) {
      case 'admin':
        return {
          ...
          action: { label: '进入风控中心', path: '/admin/risk', buttonText: '前往风控中心' },
          focuses: [
      ...
      case 'supplier':
        return {
          ...
          action: { label: '进入域名管理', path: '/supplier/domains', buttonText: '前往域名管理' },
          focuses: [
      ...
      default:
        return {
          ...
          action: { label: '进入项目市场', path: '/projects', buttonText: '前往项目市场' },
          focuses: [
